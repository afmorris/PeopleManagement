...
{
    public class RelationshipTypeSerializationConverter : JsonConverter
    {
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            writer.WriteValue((value as RelationshipType)?.ToString());
        }
        ...
        public override bool CanConvert(Type objectType) => objectType == typeof(RelationshipType);
    }
}