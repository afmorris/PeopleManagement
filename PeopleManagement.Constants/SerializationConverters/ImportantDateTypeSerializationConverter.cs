...
{
    public class ImportantDateTypeSerializationConverter : JsonConverter
    {
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            writer.WriteValue((value as ImportantDateType)?.ToString());
        }
        ...
        public override bool CanConvert(Type objectType) => objectType == typeof(ImportantDateType);
    }
}